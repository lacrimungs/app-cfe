...
public class FormularioCursoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        calendarioImagen2 = view.findViewById(R.id.calendario); // Imagen para segunda fecha

        // Configurar los Spinners
        sistemaSpinner = view.findViewById(R.id.sistema_spinner);
        ArrayAdapter<CharSequence> sistemaAdapter = ArrayAdapter.createFromResource(getContext(),
                R.array.spinner_items_3, android.R.layout.simple_spinner_item);
        ...
        ArrayAdapter<CharSequence> recordatorioAdapter = ArrayAdapter.createFromResource(getContext(),
    ...
    private void guardarCurso() {
        ...
        Curso curso = new Curso(nombreCurso, motivoCurso, fechaCurso, sistema, recordatorio);
